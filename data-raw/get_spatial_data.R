...
mke_basin_sf <- arcpullr::get_spatial_layer(url = url, where = "HUC10_CODE IN ('0404000304', '0404000305', '0404000306', '0404000303')")
mke_basin_sf <-  
  mke_basin_sf |>
  dplyr::mutate(HUC10_NAME = 
    dplyr::if_else(grepl("Milwaukee", HUC10_NAME), "Lower Milwaukee River", HUC10_NAME))
...
mke_rivers_sf <- 
  ...
  dplyr::select(RIVER_SYS_WBIC, RIVER_SYS_NAME, ROW_NAME, STREAM_ORDER) |>
  sf::st_join(
